    ...
    <section className="text-gray-600 body-font ">
      ...
      {/* <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-wrap -m-4 items-center justify-center gap-2">
              <div className="md:w-1/3 p-4 w-full border rounded-3xl transform hover:scale-110 transition duration-500 ease-in-out">
                ...
                <div className="mt-4">
                  <h2 className="text-gray-900 title-font text-lg font-medium text-left ml-1">
                    Төмстэй
                  </h2>
                  <p className="mt-1 ml-1 text-left">1999.99</p>
                </div>
              </div>
              <div className="md:w-1/3 p-4 w-full border rounded-3xl transform hover:scale-110 transition duration-500 ease-in-out">
                <a className="block relative h-48 rounded overflow-hidden">
                  <img
                    alt="ecommerce"
                    className="object-none object-center w-full h-full block"
                    src="/meattt.svg"
                  />
                </a>
                <div className="mt-4 ">
